# Kalkulator Buku Log UPB V3.1

Penambahbaikan V3.1:
- Logo Arus Logic menggunakan PNG transparent sebenar untuk paparan atas latar gelap/cerah.
- Kotak putih pada logo di splash dibuang.
- Footer halaman pengiraan dipusatkan.
- Logo Arus Logic di footer dibesarkan dan dipusatkan.

# Kalkulator Buku Log UPB — V3
...
## Hak cipta
© 2026 Arus Logic by Zaikeri_Rosli. All rights reserved.
